    ...
    <main className="min-h-screen overflow-hidden bg-[#f7f7f5]">
      <div className="relative mx-auto flex min-h-screen max-w-6xl flex-col px-6 py-7 sm:px-10 sm:py-9">
        ...
        <img
          ...
          className="pointer-events-none absolute bottom-0 right-0 h-auto w-full max-w-none rounded-t-xl object-contain sm:right-[-9%] sm:h-[86%] sm:w-auto sm:rounded-xl lg:right-0"
          src="/images/cheomseongdae-paper-cut.png"
        />
        <section className="relative z-10 mt-28 max-w-xl sm:mt-auto sm:pb-20 lg:pb-28">
