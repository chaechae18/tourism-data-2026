...
export default function BottomNavigation({ activeTab, onChange }) {
  return (
    <nav className="fixed inset-x-0 bottom-0 z-30 border-t border-[#e2e4e0] bg-white/95 px-2 pb-[max(0.6rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur lg:static lg:rounded-lg lg:border lg:p-2" aria-label="주요 메뉴">
