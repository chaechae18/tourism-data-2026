  ...
  return (
    <section className="space-y-7">
      ...
      <div>
        ...
        <div className="space-y-3">
          {HOME_CONTENT.festivals.map((festival) => (
            <article key={festival.id} className="rounded-lg border border-[#e6ddd2] bg-white p-4">
      ...
      <div className="border-y border-[#e6ddd2] py-5">
        ...
        <a href={HOME_CONTENT.tourismUrl} target="_blank" rel="noreferrer" className="mt-4 inline-flex items-center gap-1 text-sm font-bold text-[#9a4e17] hover:text-[#6f3210]">경주 관광 정보 <ChevronRight size={16} /></a>
      </div>
    </section>
  );
}
