...
export const MESSAGES = {
  ko: {
    ...
    roles: {
      title: "역할 선택", previous: "이전 역할", next: "다음 역할", select: "{name} 선택", guide: "신라 사람 중 하나를 고르면, 그 인물이 다녔을 법한 하루 코스를 지도에 그려 드려요.",
