...
export const MESSAGES = {
  ko: {
    ...
    myPage: {
      ...
      visited: "내가 다녀간 장소", noVisited: "아직 방문 완료한 장소가 없어요.", saveFailed: "언어 설정을 저장하지 못했습니다.",
  ...
  en: {
    ...
    myPage: { guide: "See the app guide again", title: "My travel settings", nickname: "Nickname", nicknameSaved: "Nickname saved.", language: "Language", visited: "Places I visited", noVisited: "You have not completed any visits yet.", saveFailed: "Could not save the language setting.", saved: "Language setting saved.", unavailable: "The {name} screen will be available after backend integration.", privacy: "Edit personal information", places: "Places I visited", contact: "Contact us.", withdraw: "Delete account" },
  ...
  ja: {
    ...
    myPage: { guide: "アプリの使い方をもう一度見る", title: "旅行設定", nickname: "ニックネーム", nicknameSaved: "ニックネームを保存しました。", language: "言語設定", visited: "訪問した場所", noVisited: "まだ訪問完了した場所はありません。", saveFailed: "言語設定を保存できませんでした。", saved: "言語設定を保存しました。", unavailable: "{name}画面はバックエンド接続後に利用できます。", privacy: "個人情報を編集", places: "訪問した場所", contact: "お問い合わせ", withdraw: "退会" },
  ...
  zh: {
    ...
    myPage: { guide: "再看一次应用指南", title: "我的旅行设置", nickname: "昵称", nicknameSaved: "昵称已保存。", language: "语言设置", visited: "我去过的地方", noVisited: "您还没有完成任何到访。", saveFailed: "无法保存语言设置。", saved: "语言设置已保存。", unavailable: "连接后端后将提供{name}页面。", privacy: "修改个人信息", places: "我去过的地方", contact: "联系我们", withdraw: "注销账号" },
