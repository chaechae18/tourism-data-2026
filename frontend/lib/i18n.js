...
export const MESSAGES = {
  ko: {
    camera: {"title": "동경이와 사진찍기", "guide": "카메라 속 나와 동경이를 함께 담아보세요.", "review": "사진 저장을 누른 뒤 저장·공유 메뉴가 열리면 저장할 위치를 선택하세요. 반응이 없으면 사진을 길게 누르거나 마우스 오른쪽 버튼으로 눌러 저장해보세요.", "preview": "동경이와 함께 찍은 사진", "live": "카메라 미리보기", "loading": "카메라를 준비하고 있어요. 접근 권한을 허용해주세요.", "unsupported": "카메라를 사용할 수 없어요. HTTPS 또는 localhost에서 지원되는 브라우저로 열어주세요.", "denied": "카메라 권한이 필요해요. 브라우저 설정에서 카메라를 허용한 뒤 다시 시도해주세요.", "notFound": "연결된 카메라를 찾을 수 없어요.", "failed": "카메라를 열지 못했어요. 다른 앱에서 사용 중인지 확인해주세요.", "retake": "다시 찍기", "save": "사진 저장", "switch": "카메라 전환", "shutter": "촬영", "retry": "다시 시도"},
    common: {
      close: "닫기", save: "저장", change: "바꾸기", ready: "준비 중",
      networkError: "서버에 연결하지 못했습니다.", requestError: "요청을 처리하지 못했습니다.",
    },
    intro: {
      title: "천년의 경주, 이야기를 따라",
      description: "동경이와 함께 미션을 해결하고, 나만의 경주 여행을 완성해 보세요.",
      login: "로그인", gatheringLabel: "한 줄로 나란히 서 있는 여섯 역할의 동경이", artworkLabel: "움직이는 종이 물결 안의 첨성대 일러스트",
    },
    auth: {
    ...
    home: {
      title: "동경이와 천년의 역사\u00a0도시 경주를 걸어보세요", description: "문화유산과 진행중인 행사를 한눈에 확인하세요.",
    ...
    map: {
      ...
      currentRole: "지금 역할", followingRole: "{name}의 자취를 따라가는 중", near: "가까워요", walkDistance: "도보 거리", duration: "예상 시간",
      ...
      docentTitle: "도슨트 이야기", docentSubtitle: "천천히 읽어보세요",docentTitle2: "도슨트",currentPlace: "지금 듣는 곳",
    },
    roles: {
      title: "역할 선택", previous: "이전 역할", next: "다음 역할", select: "{name} 선택", guide: "신라 역할 중 하나를 고르면 그 사람이 보냈을 법한 하루를 지도 위에 그려드려요.",
      courseReady: "코스 준비됨", pending: "준비 중",
      king: { name: "왕", tagline: "궁궐과 왕릉을 따라", description: "월성에서 시작해 왕릉을 잇는 하루." },
    ...
    donggyeong: { title: "동경이 꾸미기", noItems: "획득한 아이템이 없어요", unequip: "착용 해제", save: "착장 저장", photo: "사진찍기", photoError: "사진을 저장하지 못했어요. 다시 시도해 주세요.", mine: "내 동경이", inventory: "인벤토리", quests: "방문 퀘스트", viewerLabel: "3D 동경이 캐릭터 뷰어", greet: "인사하기", loading: "동경이를 불러오는 중…", loadError: "모델을 불러오지 못했어요", presets: "역할별 착장", reset: "모두 해제" },
    slots: { hat: "머리", accessory: "장식", clothes: "의상", hand: "손", top: "상의", bottom: "하의", effect: "배경" },
    ...
    myPage: {
      title: "내 여행 설정", nickname: "닉네임", nicknameSaved: "닉네임을 저장했어요.", language: "언어 설정", history: "방문 기록", ticketCount: "장의 티켓", mapGuide: "티켓을 누르면 해당 장소를\n지도에서 확인할 수 있어요.",
      visited: "내가 다녀간 장소", visitedDescription: "방문한 경주 명소를 확인해보세요.", noVisited: "아직 방문 완료한 장소가 없어요.", saveFailed: "언어 설정을 저장하지 못했습니다.",
      saved: "언어 설정을 저장했어요.", unavailable: "{name} 화면은 백엔드 연결 후 제공됩니다.", description: "경주의 장소를 방문하고 여행 티켓을 모아보세요.",
      guide: "앱 사용법 다시 보기", privacy: "개인정보 수정", places: "내가 다녀간 장소", contact: "Contact us.", withdraw: "회원 탈퇴", logout: "로그아웃",
      ...
      visitedPlaces: { ticketTitle: "나의 여행 티켓", ticketDescription: "다녀온 장소를 여행 티켓으로 모아봤어요.", collectedTickets: "모은 티켓", tickets: "티켓",  loading: "방문 기록을 불러오는 중이에요.", empty: { title: "아직 다녀간 장소가 없어요." } }
    },
    notifications: {
    ...
    spots: {
      ...
      blockedReview: "한줄평에 사용할 수 없는 표현이 있어요.", created: "스팟이 공개됐어요.",
      deleteConfirm: "이 스팟을 삭제할까요?", deleted: "스팟을 삭제했어요.", blockedComment: "댓글에 사용할 수 없는 표현이 있어요.",
      commentCreated: "댓글이 등록됐어요.", contentRejected: "욕설이나 선정적인 내용은 게시할 수 없어요. 내용을 수정해 주세요.", moderationUnavailable: "검수를 완료하지 못했어요. 잠시 후 다시 시도해 주세요.", invalidModerationImage: "검수할 사진을 확인할 수 없어요. 사진을 다시 업로드해 주세요.",
      ...
      translate: "번역하기", showOriginal: "원문 보기", translating: "번역 중...",
      translateFailed: "번역하지 못했어요. 잠시 후 다시 시도해 주세요.",
    },
  },
  en: {
    camera: {"title": "Photo with Donggyeong", "guide": "Get in the camera frame with Donggyeong.", "review": "Tap Save photo and choose a destination if a save or share menu opens. If nothing happens, press and hold or right-click the photo to save it.", "preview": "Photo with Donggyeong", "live": "Camera preview", "loading": "Starting the camera. Please allow camera access.", "unsupported": "Camera access is unavailable. Use a supported browser on HTTPS or localhost.", "denied": "Allow camera access in your browser settings, then try again.", "notFound": "No connected camera was found.", "failed": "Could not open the camera. Check whether another app is using it.", "retake": "Retake", "save": "Save photo", "switch": "Switch camera", "shutter": "Capture", "retry": "Try again"},
    ...
    intro: { title: "A thousand years of Gyeongju,\none story at a time.", description: "Complete missions with Donggyeong and create your own Gyeongju journey.", login: "Log in", gatheringLabel: "Six Donggyeong companions standing together in a row", artworkLabel: "Cheomseongdae illustration amid animated paper waves" },
    ...
    myPage: { mapGuide: "Tap a ticket to view the place on the map." ,ticketCount: " tickets", history: "Visit History",description: "Visit places in Gyeongju and collect travel tickets.", visitedPlaces: { ticketTitle: "My Travel Tickets", ticketDescription: "Collect the places you've visited as travel tickets.", collectedTickets: "Collected Tickets", tickets: "Tickets", loading: "Loading your visit history.", empty: { title: "You haven't visited any places yet." }},personalInfo: { back: "Go back", title: "Edit Personal Information", description: "Manage your profile information", basicInfo: "Basic Information", nickname: "Nickname", nicknamePlaceholder: "Enter your nickname", email: "Email", emailPlaceholder: "Enter your email", country: "Country", countryPlaceholder: "Enter your country", birthDate: "Date of Birth", noticeTitle: "Profile Information", noticeDescription: "The information you enter will be used to display your profile and travel records.", save: "Save", updated: "Your personal information has been updated.", updateFailed: "Failed to update your personal information." },guide: "See the app guide again", title: "My travel settings", nickname: "Nickname", nicknameSaved: "Nickname saved.", language: "Language", visited: "Places I visited", visitedDescription: "Check the Gyeongju places you have visited.", noVisited: "You have not completed any visits yet.", saveFailed: "Could not save the language setting.", saved: "Language setting saved.", unavailable: "The {name} screen will be available after backend integration.", privacy: "Edit personal information", places: "Places I visited", contact: "Contact us.", withdraw: "Delete account" ,logout: "Logout"},
  ...
  ja: {
    ...
    map: { currentPlace: "再生中のスポット",docentTitle2: "音声ガイド", docentTitle: "解説ストーリー", docentSubtitle: "ゆっくりとお読みください", title: "慶州2D地図", illustrationLabel: "実際の位置関係を反映した慶州イラスト地図", rangeLabel: "地図範囲", city: "市内中心部", all: "慶州全域", currentLocation: "現在地", findLocation: "現在地を探す", unsupportedLocation: "このブラウザでは位置情報を利用できません。", locating: "現在地を確認しています。", outside: "慶州観光圏外です。デモ位置を維持します。", located: "現在地を地図に表示しました。", permission: "位置情報を許可すると近くの場所を確認できます。", routeKey: "TMAPキーが必要です。", routeLoaded: "TMAP徒歩ルートを読み込みました。", routeFailed: "TMAPに接続できませんでした。", currentRole: "現在の役割", followingRole: "{name}の足跡をたどっています", near: "近い", walkDistance: "徒歩距離", duration: "予想時間", routeLoading: "ルート読込中", routeAgain: "TMAPルートを再表示", route: "TMAPルート検索", visited: "訪問済み", complete: "クエスト完了", docent: "ガイドを聴く", pending: "準備中", minutes: "{minutes}分", hoursMinutes: "{hours}時間{minutes}分", start: "出発", closedNotice: " ※ 休業日要確認", reroll: "コースを作り直す", within1km: "1km以内", beyond1km: "1km超", selectPlace: "{name}を選択", zoomIn: "地図を拡大", zoomOut: "地図を縮小", zoomReset: "地図を元に戻す", operatingHours: "営業時間", parking: "駐車", restDate: "休業日", menu: "メニュー" },
    roles: { title: "役割を選択", previous: "前の役割", next: "次の役割", select: "{name}を選ぶ", guide: "新羅の役割を選ぶと、その人が過ごしたような一日を地図に描きます。", courseReady: "コース準備完了", pending: "準備中", king: { name: "王", tagline: "宮殿と王陵をたどる", description: "月城から王陵をたどる一日。" }, scholar: { name: "学者", tagline: "書院と碑石の間を歩く", description: "古い文字が残る書院や碑石を訪ねる一日。" }, monk: { name: "学僧", tagline: "寺と仏像を訪ねる", description: "山寺と磨崖仏を巡り心を整える一日。" }, hwarang: { name: "花郎", tagline: "南山と渓谷を巡る", description: "山道と水辺で心身を鍛える一日。" }, court_lady: { name: "宮女", tagline: "宮中の物語をたどる", description: "宮殿の裏に残る足跡と小さな物語を探します。" }, merchant: { name: "商人", tagline: "市場を歩き回る", description: "市場や商店を巡り、慶州の品々を見る一日。" } },
    donggyeong: { title: "トンギョンを着せ替え", noItems: "獲得したアイテムはありません", unequip: "外す", save: "コーデを保存", photo: "写真を撮る", photoError: "写真を保存できませんでした。もう一度お試しください。", mine: "私のトンギョン", inventory: "アイテム", quests: "訪問クエスト", viewerLabel: "3Dトンギョンキャラクタービューア", greet: "挨拶する", loading: "読み込み中…", loadError: "読み込めませんでした", presets: "役割別の衣装", reset: "すべて外す" },
    slots: { hat: "頭", accessory: "アクセサリー", clothes: "衣装", hand: "手", top: "上着", bottom: "ボトムス", effect: "背景" },
    ...
    spots: { title: "私の慶州スポット", navLabel: "スポットメニュー", ranking: "ランキング", spots: "スポット", create: "スポット登録", rankingTitle: "今日のスポットランキング", publicTitle: "公開スポット", mineTitle: "自分の投稿", postTitle: "スポット投稿", pending: "審査待ち", approved: "承認", rejected: "却下", like: "いいね", unlike: "いいね取消", comment: "コメント", bookmark: "保存", unbookmark: "保存解除", deleteMine: "自分のスポットを削除", firstComment: "最初のコメントを残しましょう。", commentPlaceholder: "コメントを入力", submitComment: "投稿", noMine: "まだ投稿がありません。", sortLabel: "スポット並び順", sort: "並び順", sortLikes: "いいね順", sortNewest: "新着順", searchLabel: "場所を検索", locationPlaceholder: "どこで見つけましたか？", locating: "近くの場所を検索中...", resetLabel: "本日00:00時点", nearby: "現在地周辺", radius: "現在地から2km以内", nearest: "近い順", photo: "写真", choosePhoto: "写真を選択", review: "ひとこと", reviewPlaceholder: "慶州で見つけた瞬間を350字以内で残してください。", submitting: "登録中...", share: "スポットを共有", geolocationUnsupported: "このブラウザでは位置情報を利用できません。", nearbyLoaded: "現在地周辺の場所を読み込みました。", nearbyEmpty: "現在地周辺に登録できる場所がありません。", permissionDenied: "位置情報の許可が必要です。許可するか手動で検索してください。", positionUnavailable: "現在地を確認できません。手動で検索してください。", timeout: "位置情報の確認がタイムアウトしました。", locationFailed: "現在地を確認できませんでした。", selectPlace: "検索結果から場所を選び、ひとことを入力してください。", blockedReview: "ひとことに使用できない表現があります。", created: "スポットを公開しました。", deleteConfirm: "このスポットを削除しますか？", deleted: "スポットを削除しました。", blockedComment: "コメントに使用できない表現があります。", commentCreated: "コメントを投稿しました。", contentRejected: "暴言や性的な内容は投稿できません。内容を修正してください。", moderationUnavailable: "審査を完了できませんでした。しばらくしてから再試行してください。", invalidModerationImage: "写真を確認できませんでした。再度アップロードしてください。", photoAlt: "{name}の写真", openPost: "{name}の投稿を開く", previewAlt: "{name}のプレビュー", postPhotoAlt: "{name}の投稿写真", spotPlaceholder: "スポットカード枠 {index}", rankingPlaceholder: "ランキングカード枠 {rank}", translate: "翻訳する", showOriginal: "原文を表示", translating: "翻訳中...", translateFailed: "翻訳できませんでした。しばらくしてからもう一度お試しください。" },
  },
  zh: {
    camera: {"title": "和东庆一起拍照", "guide": "让镜头中的你和东庆一起合影吧。", "review": "点击“保存照片”，如果弹出保存或分享菜单，请选择保存位置。如果没有反应，请长按或右键点击照片进行保存。", "preview": "和东庆的合影", "live": "相机预览", "loading": "正在启动相机，请允许访问相机。", "unsupported": "无法使用相机。请使用支持的浏览器，通过HTTPS或localhost打开。", "denied": "请在浏览器设置中允许访问相机，然后重试。", "notFound": "未找到已连接的相机。", "failed": "无法打开相机，请检查其他应用是否正在使用相机。", "retake": "重拍", "save": "保存照片", "switch": "切换相机", "shutter": "拍照", "retry": "重试"},
    common: { close: "关闭", save: "保存", change: "更改", ready: "准备中", networkError: "无法连接服务器。", requestError: "无法处理请求。" },
    intro: { title: "千年庆州，\n循着故事前行。", description: "与东庆一起完成任务，打造属于你的庆州之旅。", login: "登录", gatheringLabel: "六种角色的东庆并排站在一起", artworkLabel: "动态纸浪中的瞻星台插画" },
    ...
    map: { currentPlace: "正在播放", docentTitle2: "语音导览", docentTitle: "语音导览故事", docentSubtitle: "请慢用细读",title: "庆州2D地图", illustrationLabel: "反映实际位置比例的庆州插画地图", rangeLabel: "地图范围", city: "市中心", all: "庆州全域", currentLocation: "当前位置", findLocation: "查找当前位置", unsupportedLocation: "此浏览器无法使用定位功能。", locating: "正在确认当前位置。", outside: "您位于庆州旅游区域之外，将保留演示位置。", located: "已在地图上显示当前位置。", permission: "允许定位后即可查看附近地点。", routeKey: "需要连接 TMAP 密钥。", routeLoaded: "已加载 TMAP 步行路线。", routeFailed: "无法连接 TMAP，请稍后重试。", currentRole: "当前角色", followingRole: "正在追寻{name}的足迹", near: "很近", walkDistance: "步行距离", duration: "预计时间", routeLoading: "正在加载路线", routeAgain: "再次查看 TMAP 路线", route: "TMAP 导航", visited: "已到访", complete: "完成任务", docent: "收听导览", pending: "准备中", minutes: "{minutes}分钟", hoursMinutes: "{hours}小时{minutes}分钟", start: "出发", closedNotice: " ※ 请确认休息日", reroll: "重新生成路线", within1km: "1公里以内", beyond1km: "超过1公里", selectPlace: "选择{name}", zoomIn: "放大地图", zoomOut: "缩小地图", zoomReset: "重置地图", operatingHours: "营业时间", parking: "停车", restDate: "休息日", menu: "菜单" },
    roles: { title: "选择角色", previous: "上一个角色", next: "下一个角色", select: "选择{name}", guide: "选择一个新罗角色，我们会在地图上描绘他可能度过的一天。", courseReady: "路线已就绪", pending: "准备中", king: { name: "王", tagline: "沿着宫殿与王陵", description: "从月城出发连接王陵的一天。" }, scholar: { name: "学者", tagline: "穿行书院与碑石之间", description: "沿着留有古文的书院和碑石漫步一天。" }, monk: { name: "学僧", tagline: "探访寺院与佛像", description: "巡游山寺和摩崖佛，静心的一天。" }, hwarang: { name: "花郎", tagline: "穿越南山与溪谷", description: "在山路和水道间修炼身心的一天。" }, court_lady: { name: "宫女", tagline: "追寻宫中的故事", description: "寻找宫殿背后留下的痕迹与小故事。" }, merchant: { name: "商人", tagline: "穿梭市集", description: "逛市场和商铺，了解庆州物产的一天。" } },
    donggyeong: { title: "装扮东庆", noItems: "暂无已获得的物品", unequip: "脱下", save: "保存装扮", photo: "拍照", photoError: "照片保存失败，请重试。", mine: "我的东庆", inventory: "物品栏", quests: "到访任务", viewerLabel: "3D东庆角色查看器", greet: "打招呼", loading: "正在加载…", loadError: "模型加载失败", presets: "角色服装", reset: "全部脱下" },
    slots: { hat: "头部", accessory: "饰品", clothes: "服装", hand: "手持", top: "上装", bottom: "下装", effect: "背景" },
...
export function translateError(error, t, fallbackKey = "common.requestError") {
  const moderationKey = { CONTENT_REJECTED: "contentRejected", MODERATION_UNAVAILABLE: "moderationUnavailable", INVALID_MODERATION_IMAGE: "invalidModerationImage" }[error?.code];
  if (moderationKey) return t(`spots.${moderationKey}`);
