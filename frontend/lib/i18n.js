...
export const MESSAGES = {
  ko: {
    ...
    donggyeong: { title: "동경이 꾸미기", noItems: "획득한 아이템이 없어요", unequip: "착용 해제", save: "착장 저장", mine: "내 동경이", inventory: "인벤토리", quests: "방문 퀘스트", viewerLabel: "3D 동경이 캐릭터 뷰어", greet: "인사하기", loading: "동경이를 불러오는 중…", loadError: "모델을 불러오지 못했어요", presets: "역할별 착장", reset: "모두 해제" },
  ...
  en: {
    ...
    donggyeong: { title: "Dress up Donggyeong", noItems: "No items collected yet", unequip: "Unequip", save: "Save outfit", mine: "My Donggyeong", inventory: "Inventory", quests: "Visit quests", viewerLabel: "3D Donggyeong character viewer", greet: "Say hello", loading: "Loading Donggyeong…", loadError: "Could not load the model", presets: "Role outfits", reset: "Remove all" },
  ...
  ja: {
    ...
    donggyeong: { title: "トンギョンを着せ替え", noItems: "獲得したアイテムはありません", unequip: "外す", save: "コーデを保存", mine: "私のトンギョン", inventory: "アイテム", quests: "訪問クエスト", viewerLabel: "3Dトンギョンキャラクタービューア", greet: "挨拶する", loading: "読み込み中…", loadError: "読み込めませんでした", presets: "役割別の衣装", reset: "すべて外す" },
  ...
  zh: {
    ...
    donggyeong: { title: "装扮东庆", noItems: "暂无已获得的物品", unequip: "脱下", save: "保存装扮", mine: "我的东庆", inventory: "物品栏", quests: "到访任务", viewerLabel: "3D东庆角色查看器", greet: "打招呼", loading: "正在加载…", loadError: "模型加载失败", presets: "角色服装", reset: "全部脱下" },
