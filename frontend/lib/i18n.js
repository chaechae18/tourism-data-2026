...
export const MESSAGES = {
  ko: {
    camera: {"title": "동경이와 사진찍기", "guide": "카메라 속 나와 동경이를 함께 담아보세요.", "review": "사진을 확인하고 기기에 저장하세요.", "preview": "동경이와 함께 찍은 사진", "live": "카메라 미리보기", "loading": "카메라를 준비하고 있어요. 접근 권한을 허용해주세요.", "unsupported": "카메라를 사용할 수 없어요. HTTPS 또는 localhost에서 지원되는 브라우저로 열어주세요.", "denied": "카메라 권한이 필요해요. 브라우저 설정에서 카메라를 허용한 뒤 다시 시도해주세요.", "notFound": "연결된 카메라를 찾을 수 없어요.", "failed": "카메라를 열지 못했어요. 다른 앱에서 사용 중인지 확인해주세요.", "retake": "다시 찍기", "save": "사진 저장", "switch": "카메라 전환", "shutter": "촬영", "retry": "다시 시도"},
    common: {
  ...
  en: {
    camera: {"title": "Photo with Donggyeong", "guide": "Get in the camera frame with Donggyeong.", "review": "Review your photo and save it to your device.", "preview": "Photo with Donggyeong", "live": "Camera preview", "loading": "Starting the camera. Please allow camera access.", "unsupported": "Camera access is unavailable. Use a supported browser on HTTPS or localhost.", "denied": "Allow camera access in your browser settings, then try again.", "notFound": "No connected camera was found.", "failed": "Could not open the camera. Check whether another app is using it.", "retake": "Retake", "save": "Save photo", "switch": "Switch camera", "shutter": "Capture", "retry": "Try again"},
  ...
  zh: {
    camera: {"title": "和东庆一起拍照", "guide": "让镜头中的你和东庆一起合影吧。", "review": "确认照片后保存到设备。", "preview": "和东庆的合影", "live": "相机预览", "loading": "正在启动相机，请允许访问相机。", "unsupported": "无法使用相机。请使用支持的浏览器，通过HTTPS或localhost打开。", "denied": "请在浏览器设置中允许访问相机，然后重试。", "notFound": "未找到已连接的相机。", "failed": "无法打开相机，请检查其他应用是否正在使用相机。", "retake": "重拍", "save": "保存照片", "switch": "切换相机", "shutter": "拍照", "retry": "重试"},
