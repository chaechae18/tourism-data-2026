...
export const MESSAGES = {
  ko: {
    ...
    home: {
      title: "동경이와 천년 도시를 걸어보세요", description: "가까운 문화유산과 지금 열리고 있는 이야기를 한눈에 확인하세요.",
      nearby: "가까운 장소 보기", notice: "지금 알려드려요", noticeCount: "{count}건", noNotice: "새로운 공지가 없어요.", detail: "자세히 보기",
    ...
    roles: {
      ...
      monk: { name: "학승", tagline: "절과 불상을 찾아", description: "산사와 마애불을 돌며 마음을 다스리는 하루." },
    ...
    myPage: {
      ...
      privacy: "개인정보 수정", places: "내가 다녀간 장소", contact: "Contact us.", withdraw: "회원 탈퇴",
    },
    notifications: {
      label: "알림", description: "좋아요와 퀘스트 소식을 확인하세요.", empty: "새 알림이 없어요.",
  ...
  en: {
    ...
    home: { title: "Walk through the thousand-year city with Donggyeong", description: "Find nearby heritage sites and stories happening now at a glance.", nearby: "Explore nearby places", notice: "Latest notices", noticeCount: "{count} notices", noNotice: "There are no new notices.", detail: "View details", news: "Gyeongju news", noBanner: "There are no active banners.", festivals: "Upcoming events", noFestival: "There are no upcoming events.", starts: "Starts {date}", ends: "Ends {date}", festivalInfo: "Event details", recommended: "Recommended places", recommendedPage: "Recommended places page {page}", noRecommended: "There are no recommendations yet.", tourismInfo: "Gyeongju tourism information" },
    ...
    myPage: { title: "My travel settings", nickname: "Nickname", nicknameSaved: "Nickname saved.", language: "Language", visited: "Places I visited", noVisited: "You have not completed any visits yet.", saveFailed: "Could not save the language setting.", saved: "Language setting saved.", unavailable: "The {name} screen will be available after backend integration.", privacy: "Edit personal information", places: "Places I visited", contact: "Contact us.", withdraw: "Delete account" },
    notifications: { label: "Notifications", description: "See updates about likes and quests.", empty: "No new notifications.", SPOT_LIKE: { title: "New like", message: "Someone liked your spot." }, QUEST_COMPLETED: { title: "Quest complete", message: "You completed a quest." } },
  ...
  ja: {
    ...
    home: { title: "トンギョンと千年の都を歩きましょう", description: "近くの文化遺産と今楽しめる物語をひと目で確認できます。", nearby: "近くの場所を見る", notice: "お知らせ", noticeCount: "{count}件", noNotice: "新しいお知らせはありません。", detail: "詳しく見る", news: "慶州ニュース", noBanner: "表示中のバナーはありません。", festivals: "開催予定のイベント", noFestival: "予定されているイベントはありません。", starts: "{date}開始", ends: "{date}終了", festivalInfo: "イベント情報", recommended: "おすすめ観光地", recommendedPage: "おすすめ観光地 {page}ページ", noRecommended: "おすすめはまだありません。", tourismInfo: "慶州観光情報" },
    ...
    myPage: { title: "旅行設定", nickname: "ニックネーム", nicknameSaved: "ニックネームを保存しました。", language: "言語設定", visited: "訪問した場所", noVisited: "まだ訪問完了した場所はありません。", saveFailed: "言語設定を保存できませんでした。", saved: "言語設定を保存しました。", unavailable: "{name}画面はバックエンド接続後に利用できます。", privacy: "個人情報を編集", places: "訪問した場所", contact: "お問い合わせ", withdraw: "退会" },
    notifications: { label: "通知", description: "いいねとクエストのお知らせを確認できます。", empty: "新しい通知はありません。", SPOT_LIKE: { title: "新しいいいね", message: "あなたのスポットにいいねが付きました。" }, QUEST_COMPLETED: { title: "クエスト達成", message: "クエストを完了しました。" } },
  ...
  zh: {
    ...
    home: { title: "与东庆漫步千年古都", description: "一眼查看附近的文化遗产和正在发生的故事。", nearby: "查看附近地点", notice: "最新通知", noticeCount: "{count}条", noNotice: "暂无新通知。", detail: "查看详情", news: "庆州资讯", noBanner: "暂无展示中的横幅。", festivals: "即将举行的活动", noFestival: "暂无即将举行的活动。", starts: "{date}开始", ends: "{date}结束", festivalInfo: "活动信息", recommended: "推荐景点", recommendedPage: "推荐景点第{page}页", noRecommended: "暂无推荐景点。", tourismInfo: "庆州旅游信息" },
    ...
    myPage: { title: "我的旅行设置", nickname: "昵称", nicknameSaved: "昵称已保存。", language: "语言设置", visited: "我去过的地方", noVisited: "您还没有完成任何到访。", saveFailed: "无法保存语言设置。", saved: "语言设置已保存。", unavailable: "连接后端后将提供{name}页面。", privacy: "修改个人信息", places: "我去过的地方", contact: "联系我们", withdraw: "注销账号" },
    notifications: { label: "通知", description: "查看点赞和任务消息。", empty: "暂无新通知。", SPOT_LIKE: { title: "新的点赞", message: "有人赞了你的景点。" }, QUEST_COMPLETED: { title: "任务完成", message: "你完成了一项任务。" } },
