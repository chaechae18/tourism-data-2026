...
export const AUTH_COPY = {
  introTitle: "경주를 더 가깝게 걷는 방법",
  introDescription: "동경이와 함께 장소를 발견하고, 퀘스트와 나만의 여행 기록을 완성해 보세요.",
...
export const QUESTS = [
  { id: "bunhwangsa", name: "분황사", description: "모전석탑의 인왕상을 찾아보세요.", distance: "420m", mapX: 190, mapY: 116, docent: true },
  { id: "cheomseongdae", name: "첨성대", description: "별을 읽던 신라의 시간을 만나보세요.", distance: "780m", mapX: 132, mapY: 168, docent: true },
  { id: "donggung", name: "동궁과 월지", description: "물 위에 비친 궁궐의 밤을 기록해 보세요.", distance: "1.2km", mapX: 246, mapY: 176, docent: false },
  { id: "bulguksa", name: "불국사", description: "두 탑 사이에서 오래된 약속을 찾아보세요.", distance: "12.4km", mapX: 322, mapY: 248, docent: true },
  { id: "seokguram", name: "석굴암", description: "동해를 향한 본존불의 시선을 따라가 보세요.", distance: "14.1km", mapX: 350, mapY: 208, docent: true },
];
